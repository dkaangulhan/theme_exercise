...
/// Light theme shadows of the app.
class LightThemeShadows extends AppShadowTheme {
  LightThemeShadows({
  ...
  })  : button12dp = button12dp ?? _LightShadowStyles._button12dp,
        button2dp = button2dp ?? _LightShadowStyles._button2dp,
        button4dp = button4dp ?? _LightShadowStyles._button4dp,
        button8dp = button8dp ?? _LightShadowStyles._button8dp,
        card16dp = card16dp ?? _LightShadowStyles._card16dp,
        card20dp = card20dp ?? _LightShadowStyles._card20dp,
        card24dp = card24dp ?? _LightShadowStyles._card24dp,
        card28dp = card28dp ?? _LightShadowStyles._card28dp,
        focused = focused ?? _LightShadowStyles._focused,
        hover = hover ?? _LightShadowStyles._hover,
        error = error ?? _LightShadowStyles._error,
        success = success ?? _LightShadowStyles._success;
...
abstract class _LightShadowStyles {
  const _LightShadowStyles._();
